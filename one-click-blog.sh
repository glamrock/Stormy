...
function server {  # killed off nginx because it's unecessary for one-click
...
function spooky { 
    ...
    sed -i "s/my-ghost-blog.com/$hostname/g" /var/www/ghost/config.js   
